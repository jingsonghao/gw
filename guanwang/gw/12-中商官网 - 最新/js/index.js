...
$(document).ready(function(){
		$('.time-94').mousemove(function() {
			$(".word-94").css('display', 'block');
		});
		$('.time-94').mouseout(function() {
			$(".word-94").css('display', 'none');
		});
		$('.time-00').mousemove(function() {
			$(".word-00").css('display', 'block');
		});
		$('.time-00').mouseout(function() {
			$(".word-00").css('display', 'none');
		});
		$('.time-07').mousemove(function() {
			$(".word-07").css('display', 'block');
		});
		$('.time-07').mouseout(function() {
			$(".word-07").css('display', 'none');
		});
		$('.time-13').mousemove(function() {
			$(".word-13").css('display', 'block');
		});
		$('.time-13').mouseout(function() {
			$(".word-13").css('display', 'none');
		});
		$('.time-16').mousemove(function() {
			$(".word-16").css('display', 'block');
		});
		$('.time-16').mouseout(function() {
			$(".word-16").css('display', 'none');
		});
	})	
...
$(function(){
         var i=0
	     var timer=null;
	     var len=$(".banner-Button li").length;
		$(".banner-Button li").hover(function(){
			clearInterval(timer)
			  that=$(this);
		...
		//函数的封装
		function fy(){
			$(".img1").fadeOut(200).eq(i).stop().fadeIn(800);
			$(".banner-Button li").removeClass("active").eq(i).addClass("active");
		
			}
			//	计时器添加	
	    var timer1=setInterval(auto,5000)
		function auto(){
			y++;
			if(y>$(".banner-Button li").length-1){
				y=0
			}
		fy();
		}	
